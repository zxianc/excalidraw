...
**Purpose:** Enable users to organize documents into a hierarchical folder tree, with create, rename, delete, expand/collapse operations, and persistent folder state across sessions.
