      ...
      <div className="conflict-dialog">
        ...
        <div className="conflict-dialog__body">
          ...
          <div className="conflict-dialog__versions">
            <div className="conflict-dialog__version">
              <div className="conflict-dialog__version-label">
                Local Version
              </div>
        ...
        <div className="conflict-dialog__actions">
          ...
          >
            ...
            Keep Local<small>Overwrite remote with your changes</small>
          </button>
          <button
          ...
          >
            <svg viewBox="0 0 16 16" width="16" height="16">
              <path
                ...
                stroke="currentColor"
                strokeWidth="1.5"
                d="M2 8l4-5v3h8v4H6v3z"
              />
            </svg>
            Use Remote<small>Discard local changes, use remote version</small>
          </button>
          <button
            className="conflict-dialog__btn"
          ...
          >
            <svg viewBox="0 0 16 16" width="16" height="16">
              <path
                ...
                stroke="currentColor"
                strokeWidth="1.5"
                d="M4 4h8v8H4zM8 4V1M8 15v-3M4 8H1M15 8h-3"
              />
            </svg>
            Keep Both<small>Save local as copy, load remote version</small>
          </button>
        </div>
      </div>
    </div>
